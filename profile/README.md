...
Please check out the [src/NetworkManagement](https://github.com/Othentic-Labs/core-contracts/tree/main/src/NetworkManagement) folder to learn about AVS contracts that perform with Shared security protocol.
